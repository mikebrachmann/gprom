...
static void analyzeSqliteFromProvInfo (FromItem *f);
...
static void
analyzeSqliteFromProvInfo (FromItem *f)
{
...
analyzeJoin (FromJoinExpr *j, List *parentFroms)
{
    ...
    switch(left->type)
    {
        case T_FromTableRef:
        {
            ...
            analyzeSqliteFromProvInfo(left);
        }
        break;
        case T_FromJoinExpr:
    ...
    switch(right->type)
	{
		case T_FromTableRef:
		{
		    ...
		    analyzeSqliteFromProvInfo(right);
		}
        break;
		case T_FromJoinExpr:
